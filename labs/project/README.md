...
## Problem
When traveling in a group, people pay different things (some split evenly, some not). At the end, who owes whom how much?
...
- Include **≥ 1 additional pattern** from theory (e.g., Strategy, Decorator, Command, Adapter, Facade, Proxy, Iterator, State, Template Method, Composite).
- Provide **UML**:
